...
class Block:
    """Minecraft PI block description. Can be sent to Minecraft.setBlock/s
        https://mcpirevival.miraheze.org/wiki/Minecraft:_Pi_Edition_Complete_Block_List
...
CHEST               = Block(54)
CHEST_LEFT               = Block(54, 0)
CHEST_RIGHT               = Block(54, 1)
...
STAIRS_COBBLESTONE_X_PLUS_1 = Block(STAIRS_COBBLESTONE.id, 0)
STAIRS_COBBLESTONE_X_MINUS = Block(STAIRS_COBBLESTONE.id, 1)
STAIRS_COBBLESTONE_Z_MINUS = Block(STAIRS_COBBLESTONE.id, 2)
STAIRS_COBBLESTONE_Z_PLUS = Block(STAIRS_COBBLESTONE.id, 3)
# STAIRS_COBBLESTONE_X_PLUS_2 = Block(STAIRS_COBBLESTONE.id, 8)

STAIRS_COBBLESTONE_0 = Block(STAIRS_COBBLESTONE.id, 0)
STAIRS_COBBLESTONE_2 = Block(STAIRS_COBBLESTONE.id, 1)
STAIRS_COBBLESTONE_1 = Block(STAIRS_COBBLESTONE.id, 2)
STAIRS_COBBLESTONE_3 = Block(STAIRS_COBBLESTONE.id, 3)
...
DOOR_IRON_X_MINUS           = Block(71, 0)
DOOR_IRON_Z_MINUS           = Block(71, 1)
DOOR_IRON_X_PLUS           = Block(71, 2)
DOOR_IRON_Z_PLUS           = Block(71, 3)

DOOR_WOOD_X_MINUS = Block(64, 0)
DOOR_WOOD_Z_MINUS = Block(64, 1)
DOOR_WOOD_X_PLUS = Block(64, 2)
DOOR_WOOD_Z_PLUS = Block(64, 3)

DOOR_WOOD_BOTTOM = Block(64,4)
DOOR_WOOD_UP = Block(64, 8)
